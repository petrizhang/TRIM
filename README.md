...
<h3 align="center">
TRIM: Accelerating High-Dimensional Vector Similarity Search<br/>
via Enhanced Triangle-Inequality-Based Pruning
</h3>

<p align="center">
Header-only C++ library with Python bindings<br/>
for fast Top-K and Range Search on <b>HNSW</b> and <b>IVF/PQ</b> indexes
</p>
...
**TRIM** ([Paper (SIGMOD 2026)]([https://doi.org/10.1145/3769838](https://dl.acm.org/doi/pdf/10.1145/3769838))) is a general-purpose acceleration operator for high-dimensional vector similarity search (HVSS), based on enhanced triangle-inequality pruning.
...
- seamlessly integrates into existing ANN indexes (e.g., HNSW, IVFPQ)
