...
# tIVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/glove-100.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/glove1.2m/index/glove_ivfpq4096x4.bin";C:4096;m:4;nbits:8' -s 'trim_opened:[true];gamma:[0.5];k_factor:[0.0];nprobe:[200,300,400,600,800,1000,1200,1400,1600,1800,2000]' -si "/storage/vector_data/glove1.2m/index/glove_ivfpq4096x4.bin" -sr "./results/new_QPSDCRecall_GloVe_tIVFPQ_KNN_k10.csv"
...
python3 bench.py -qt ann -k 10 -nq 100 -d "../../yitong/Datasets/tiny5m-384.hdf5" -m IVFPQfs -b 'ivfpqfs_index_path:"./tmp/index/tiny5m_ivfpqfs4096x96.bin";C:4096;m:96;nbits:4' -s 'k_factor:[2000];nprobe:[20,30,40,50,60,70,80,90,100,200,300,400,500]' -si "./tmp/index/tiny5m_ivfpqfs4096x96.bin" -sr "./results/QPSDCRecall_Tiny5m_IVFPQfs_KNN_k10.csv"


# tIVFPQfs
# GIST m=480 
python3 bench.py -qt ann -k 10 -nq 500 -d "../../yitong/Datasets/gist-960.hdf5" -m tIVFPQfs -b 'ivfpqfs_index_path:"./tmp/index/gist_tivfpqfs4096x480.bin";C:4096;m:480;nbits:4' -s 'gamma:[0.65,0.68,0.7,0.72,0.75];nprobe:[40,50,60,70,80,90,100,150,200,250,300,350,400,450,500]' -si "./tmp/index/gist_tivfpqfs4096x480.bin" -sr "./results/QPSDCRecall_GIST_tIVFPQfs_KNN_k10.csv"

# Glove m=50
python3 bench.py -qt ann -k 10 -nq 500 -d "../../yitong/Datasets/glove-100.hdf5" -m tIVFPQfs -b 'ivfpqfs_index_path:"./tmp/index/glove_tivfpqfs4096x50.bin";C:4096;m:50;nbits:4' -s 'gamma:[0.66,0.67,0.68,0.69];nprobe:[60,100,200,250,300,350,400,600,800,1000,1200,1400,1600]' -si "./tmp/index/glove_tivfpqfs4096x50.bin" -sr "./results/QPSDCRecall_GloVe_tIVFPQfs_KNN_k10.csv"

# NYTimes m=128
python3 bench.py -qt ann -k 10 -nq 500 -d "../../yitong/Datasets/nytimes-256_normalized.hdf5" -m tIVFPQfs -b 'ivfpqfs_index_path:"./tmp/index/nytimes_tivfpqfs4096x128.bin";C:4096;m:128;nbits:4' -s 'gamma:[0.73,0.74,0.75,0.76,0.77,0.78];nprobe:[20,40,60,80,100,150,200,400,600,800,1000,1200,1500,1700,2000,3000]' -si "./tmp/index/nytimes_tivfpqfs4096x128.bin" -sr "./results/QPSDCRecall_NYTimes_tIVFPQfs_KNN_k10.csv"

# Tiny5M m=192
python3 bench.py -qt ann -k 10 -nq 500 -d "../../yitong/Datasets/tiny5m-384.hdf5" -m tIVFPQfs -b 'ivfpqfs_index_path:"./tmp/index/tiny5m_tivfpqfs4096x192.bin";C:4096;m:192;nbits:4' -s 'gamma:[0.49];nprobe:[50,60,70,80,90,100,150,200,250,300,400,500,600,700]' -si "./tmp/index/tiny5m_tivfpqfs4096x192.bin" -sr "./results/QPSDCRecall_Tiny5m_tIVFPQfs_KNN_k10.csv"
...
# GloVe
# IVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/glove-100.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/glove1.2m/index/glove_ivfpq4096x4.bin";C:4096;m:4;nbits:8' -s 'trim_opened:[false];gamma:[0.0];k_factor:[6000.0];nprobe:[40,60,80,100,200,300,400,600,800,1000,1200]' -si "/storage/vector_data/glove1.2m/index/glove_ivfpq4096x4.bin" -sr "./results/new_QPSDCRecall_GloVe_IVFPQ_KNN_k10.csv"
# tIVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/glove-100.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/glove1.2m/index/glove_ivfpq4096x4.bin";C:4096;m:4;nbits:8' -s 'trim_opened:[true];gamma:[0.5];k_factor:[0.0];nprobe:[200,300,400,600,800,1000,1200,1400,1600,1800,2000]' -si "/storage/vector_data/glove1.2m/index/glove_ivfpq4096x4.bin" -sr "./results/new_QPSDCRecall_GloVe_tIVFPQ_KNN_k10.csv"

# Tiny5M
# IVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/tiny5m-384.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/tiny5m/index/tiny5m_ivfpq4096x16.bin";C:4096;m:16;nbits:8' -s 'trim_opened:[false];gamma:[0.0];k_factor:[4000.0];nprobe:[5,8,10,15,20,30,40,50,60,70,80,90,100,200,300]' -si "/storage/vector_data/tiny5m/index/tiny5m_ivfpq4096x16.bin" -sr "./results/new_QPSDCRecall_Tiny5m_IVFPQ_KNN_k10.csv"
# tIVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/tiny5m-384.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/tiny5m/index/tiny5m_ivfpq4096x16.bin";C:4096;m:16;nbits:8' -s 'trim_opened:[true];gamma:[0.45];k_factor:[0.0];nprobe:[50,60,70,80,90,100,200,300,400]' -si "/storage/vector_data/tiny5m/index/tiny5m_ivfpq4096x16.bin" -sr "./results/new_QPSDCRecall_Tiny5m_tIVFPQ_KNN_k10.csv"

# GIST
# IVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/gist-960.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/gist/index/gist_ivfpq4096x30.bin";C:4096;m:30;nbits:8' -s 'trim_opened:[false];gamma:[0.0];k_factor:[600.0];nprobe:[20,40,60,80,100,150,200,250,300,400]' -si "/storage/vector_data/gist/index/gist_ivfpq4096x30.bin" -sr "./results/new_QPSDCRecall_GIST_IVFPQ_KNN_k10.csv"
# tIVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/gist-960.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/gist/index/gist_ivfpq4096x30.bin";C:4096;m:30;nbits:8' -s 'trim_opened:[true];gamma:[0.62];k_factor:[0.0];nprobe:[40,60,80,100,150,200,250,300,400,500,600]' -si "/storage/vector_data/gist/index/gist_ivfpq4096x30.bin" -sr "./results/new_QPSDCRecall_GIST_tIVFPQ_KNN_k10.csv"

# SIFT
# IVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/sift1m-128.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/sift1m/index/sift_ivfpq4096x16.bin";C:4096;m:16;nbits:8' -s 'trim_opened:[false];gamma:[0.0];k_factor:[200.0];nprobe:[20,40,60,80,100,150,200,250,300,400]' -si "/storage/vector_data/sift1m/index/sift_ivfpq4096x16.bin" -sr "./results/new_QPSDCRecall_SIFT_IVFPQ_KNN_k10.csv"
# tIVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/sift1m-128.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/sift1m/index/sift_ivfpq4096x16.bin";C:4096;m:16;nbits:8' -s 'trim_opened:[true];gamma:[0.6];k_factor:[0.0];nprobe:[40,60,80,100,150,200,250,300,400,500,600]' -si "/storage/vector_data/sift1m/index/sift_ivfpq4096x16.bin" -sr "./results/new_QPSDCRecall_SIFT_tIVFPQ_KNN_k10.csv"


# DEEP
# IVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/deep1m-256.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/deep1m/index/deep_ivfpq4096x16.bin";C:4096;m:16;nbits:8' -s 'trim_opened:[false];gamma:[0.0];k_factor:[200.0];nprobe:[20,40,60,80,100,150,200,250,300,400]' -si "/storage/vector_data/deep1m/index/deep_ivfpq4096x16.bin" -sr "./results/new_QPSDCRecall_DEEP_IVFPQ_KNN_k10.csv"
# tIVFPQ
python3 bench.py -qt ann -k 10 -nq 1000 -d "/storage/vector_data/deep1m-256.hdf5" -m tIVFPQ -b 'ivfpq_index_path:"/storage/vector_data/deep1m/index/deep_ivfpq4096x16.bin";C:4096;m:16;nbits:8' -s 'trim_opened:[true];gamma:[0.55];k_factor:[0.0];nprobe:[40,60,80,100,150,200,250,300,400,500,600]' -si "/storage/vector_data/deep1m/index/deep_ivfpq4096x16.bin" -sr "./results/new_QPSDCRecall_DEEP_tIVFPQ_KNN_k10.csv"