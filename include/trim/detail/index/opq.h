...
struct TrimIndexOPQ {
  TrimIndexPQ pq{nullptr, nullptr};
  faiss::IndexPreTransform* transform{nullptr};

  TrimIndexOPQ(std::unique_ptr<faiss::Index> owned_index, faiss::IndexPQ* index_pq,
  ...
  void compute_pq_reconstruction_errors(IDCO* dco, ctpl::thread_pool& pool) {
    T_THROW_IF_NOT(pq.owned_index != nullptr && pq.index_pq != nullptr);
