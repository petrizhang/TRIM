...
#include "top/common/top_exception.h"
...
#define TOP_THROW_MSG(MSG)                                                 \
  do {                                                                     \
    throw top::TopException(MSG, __PRETTY_FUNCTION__, __FILE__, __LINE__); \
  } while (false)
...
#define TOP_THROW_FMT(FMT, ...)                                            \
  do {                                                                     \
    ...
    throw top::TopException(__s, __PRETTY_FUNCTION__, __FILE__, __LINE__); \
  } while (false)
