...
#include <unity/detail/faiss/impl/code_distance/code_distance-avx2.h>
...
inline void distance_four_codes(
  ...
  distance_four_codes_avx2<PQDecoderT>(M, nbits, sim_table, code0, code1, code2, code3, result0,
